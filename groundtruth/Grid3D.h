...
class Grid3D : public BioTracker::Core::ObjectModel {
  public:
    ...
    std::vector<cv::Point> const &getMiddleRingPoints() const {
        return _coordinates2D[MIDDLE_RING];
    }
    std::vector<cv::Point> const &getInnerRingPoints() const {
        return _coordinates2D[INNER_RING];
    }
